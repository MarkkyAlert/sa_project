...
<body class="grey lighten-3">
    ...
    <header>
        ...
        <div class="sidebar-fixed position-fixed overflow-auto">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="accept_order.php" class="active list-group-item list-group-item-action waves-effect mb-1">
    ...
    <main class="pt-5 mx-lg-5">
        ...
        <div class="container-fluid mt-1">
            <?php
            $query_count = "SELECT COUNT(order_no) AS count FROM orders WHERE order_status = 'accept'";
            ...
            <?php if ($row_count['count'] != 0) : ?>
                ...
                <div class="row mt-5">
                    <div class="col-12">
                        <h3 class="text-center ">รายการที่อนุมัติ: <?php echo $row_count['count'] ?> รายการ</h3>
                                ...
                                AND o.order_status = 'accept'";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) { ?>
                                        <tr>
                                            ...
                                            <td><u><a href="order_detail_accept.php?order_id=<?php echo $row['order_id']; ?>" class="text-primary"><?php echo $row['order_no']; ?></a></u></td>
            ...
            <?php if ($row_count['count'] == 0) : ?>
                <div class="row mt-5">
                    <div class="col-12">
                        <h3 class="text-center text-danger">ไม่มีรายการที่อนุมัติ</h3>
                    </div>
                </div>
            <?php endif; ?>
        </div>
