...
<body class="grey lighten-3">
    ...
    <main class="pt-5 mx-lg-5">
        ...
        <div class="container-fluid mt-1">
            <?php
            $query_count = "SELECT COUNT(order_no) AS count FROM orders WHERE delivery_status = 'waiting'";
            ...
            <?php if ($row_count['count'] != 0) : ?>
                <div class="row mt-5">
                    <div class="col-12">
                        <h3 class="text-center">รายการที่รอจัดส่ง: <?php echo $row_count['count'] ?> รายการ</h3>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-12">
...
AND o.delivery_status = 'waiting'";
            ...
            <?php if ($row_count['count'] == 0) : ?>
                <div class="row mt-5">
                    <div class="col-12">
                        <h3 class="text-center text-danger">ไม่มีรายการที่รอจัดส่ง</h3>
                    </div>
                </div>
            <?php endif; ?>
        </div>
