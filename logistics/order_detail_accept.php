    ...
    <header>
        ...
        <div class="sidebar-fixed position-fixed overflow-auto">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="accept_order.php" class="accept list-group-item list-group-item-action waves-effect mb-1">
        ...
        <div class="container-fluid mt-1">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <a href="accept_order.php" class="btn btn-danger btn-sm">BACK</a>
                </div>
