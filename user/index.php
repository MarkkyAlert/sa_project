                        ...
                        <div class="card-body">
                            <p class="card-text">
                                <form action="date_form_backend.php" id="date_form" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group mb-4 input-with-post-icon datepicker"><?php $b = substr(date('Y-d-m'),8);
$c = number_format($b);
if ($c == 1) {
	$c = '02';
}
    ...
    $c = '01';
                                                ...
                                                <input placeholder="Select date" type="date" id="date" name="date" class="form-control" min="<?php echo date('Y-m-d');?>" max="<?php echo date('Y-'.$c.'-d'); ?>">
