...
<body class="grey lighten-3">
    ...
    <main class="pt-5 mx-lg-5">
        ...
        <div class="container-fluid mt-1">
            <?php
            $query_count = "SELECT COUNT(order_no) AS count FROM orders WHERE user_id = $user_id AND delivery_status = 'waiting' OR delivery_status = 'delivering' OR delivery_status = 'success' OR delivery_status = 'failed'";
