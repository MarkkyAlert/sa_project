...
<body class="grey lighten-3">
    ...
    <main class="pt-5 mx-lg-5">
        ...
        <div class="container-fluid mt-1">
            <?php
            $query_count = "SELECT COUNT(order_no) AS count FROM orders WHERE user_id = $user_id AND order_status = 'accept'";
            ...
            <?php if ($row_count['count'] != 0) : ?>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <a href="status.php" class="btn btn-danger btn-sm">BACK</a>
                    </div>
                </div>
            <?php endif; ?>
            <?php if ($row_count['count'] == 0) : ?>
