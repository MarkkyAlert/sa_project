...
<head>
    ...
    <title>ออเดอร์ที่กำลังตรวจสอบ</title>
    ...
    <main class="pt-5 mx-lg-5">
        ...
        <div class="container-fluid mt-1">
            ...
            <?php if ($row_count['count'] != 0) : ?>
                ...
                <div class="row mt-5">
                    <div class="col-12">
                        <h3 class="text-center ">รายการที่กำลังตรวจสอบ: <?php echo $row_count['count'] ?> รายการ</h3>
            ...
            <?php if ($row_count['count'] == 0) : ?>
                <div class="row mt-5">
                    <div class="col-12">
                        <h3 class="text-center text-danger">ไม่มีรายการที่กำลังตรวจสอบ</h3>
                    </div>
                </div>
            <?php endif; ?>
        </div>
