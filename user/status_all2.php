                                ...
                                OR o.order_status = 'verifying')";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) { ?>
                                        <tr>
                                            ...
                                            <td><u><a href="order_detail_status2.php?order_id=<?php echo $row['order_id']; ?>" class="text-primary"><?php echo $row['order_no']; ?></a></u></td>
                                            <td>
                                            ...
                                            <td>
                                                <p class="text-center"><?php echo $time; ?>
                                            </td>
                                            <td>
...
<?php
if (isset($_SESSION['suc_date_form'])) {
